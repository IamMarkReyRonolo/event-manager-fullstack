	...
	<div class="declinedEventsContainer">
		...
		<div v-if="fetched" class="main">
			...
			<div class="mainContent">
				<div v-if="getPendingEvents.length > 0">
					<v-card
						class="activity"
						dark
						v-for="event in getPendingEvents"
						:key="event.id"
					>
						<div class="actHeader">
								...
								<v-dialog persistent max-width="290">
									...
									<template v-slot:default="dialog">
										<v-card light class="deleteCon">
											...
											<v-card-text
												>Cancelling this submission will delete this event and
												the request you have made to the admin.</v-card-text
											>
											<v-card-actions>
												<v-spacer></v-spacer>
												<v-btn
				...
				<div class="empty" v-if="getPendingEvents.length == 0">
					<h2>Empty</h2>
				</div>
			</div>
		</div>
